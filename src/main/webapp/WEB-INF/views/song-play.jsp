...
<div class="row">
	<div class="col-lg-12 text-center">
		<div class="cover">
			<img src="<c:url value="${song.coverUrl}" />" alt="..."
				class="cover-size">
		</div>
		<div class="lecteur">
	...
	<div class="container">
		<br />
		<h1 class="display-4 text-center">Découvrez les autres artistes
			de NorthCloudRadio</h1>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<figure class="cap-bot">
					<a ref="artists/${user.id}">${user.username} <img
						src="https://s3.eu-west-3.amazonaws.com/mp3webradio-benjixxx/profil.jpg-8"
						alt="..." class="img-thumbnail"></a>
