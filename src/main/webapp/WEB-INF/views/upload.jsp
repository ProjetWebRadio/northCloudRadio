		...
		<div class="col-lg-12">
			...
			<form:form method="post" action="upload"
				...
				<form:input class="form-control" path="category"
					placeholder="Hip-Hop, Instrumental, Chill, Electro, Trap, Dub, Hybrid Style, Autre genre" />
				<br />
				<form:label path="songFile">Choisir une musique :</form:label>
				<input class="btn btn-md btn-primary" type="file" id="songFile"
					name="songFile" />

				<br />
				<br />
				<form:label path="coverFile">Choisir une cover :</form:label>
				<input class="btn btn-md btn-primary" type="file" id="coverFile"
					name="coverFile">
				<br />
